...
async function initCombinedPlayer(profileData) {
    ...
    multiMarkerControls = THREEx.ArMultiMarkerControls.fromJSON(arToolkitContext, markerRoot, JSON.stringify(profileData));
...
function animateCombined() {
    ...
    if (arToolkitSource && arToolkitSource.ready) { 
        ...
        if (multiMarkerControls) multiMarkerControls.update();
    }
